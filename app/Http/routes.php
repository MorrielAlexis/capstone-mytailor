...
/*-----------------------------------------ALTERATION---------------------------------------------------*/
		...
		Route::get('alteration-walkin-newcustomer-alteration', 'AlterationWalkInController@alteration');
		Route::post('alteration-walkin-newcustomer-saveorder', 'AlterationWalkInController@saveOrder');

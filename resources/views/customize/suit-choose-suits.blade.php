...
<div class="row" style="margin:40px;">
  ...
  <div class="row">
    <div class="card col s12 m12 l12">   
      ...
      {!! Form::open(['url' => 'customize-suit-fabric', 'method' => 'POST', "id" => "order-form"]) !!}
        ...
        <div class="col s12" style="margin-top:15px">
          ...
          <div class = "row">
            ...
            <div class="col s3" style="margin-top:20px; padding:5px; margin-right:5px;"><input min = "1" required class = "suitquantity" name="suitquantity" value = "1" id="suitquantity" type="number" style="border:2px teal solid; padding-left:18%; padding-right:18%" placeholder="How many?"></div>
          </div>
            ...
            @if($garment->boolIsActive==1)
                ...
                <div class="col s4">
                  ...
                  <div class="center col s12">
                    <input type="radio" name = "suits" class="filled-in cbx-segment-name" id="{{$garment->strSegmentID}}" value="{{$garment->strSegmentID}}" style="padding:5px"/>

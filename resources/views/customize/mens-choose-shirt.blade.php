            ...
            @if($garment->boolIsActive==1)
                ...
                <div class="col s4">
                  ...
                  <div class="center col s12">
                    <input type="radio" name = "menshirt" class="filled-in cbx-segment-name" id="{{$garment->strSegmentName}}" value="{{$garment->strSegmentName}}" style="padding:5px"/>
                    <label for="{{$garment->strSegmentName}}">{{$garment->strSegmentName}}</label>
                  </div>

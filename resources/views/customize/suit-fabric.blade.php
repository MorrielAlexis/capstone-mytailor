...
<div class="row" style="margin:40px;">
    ...
    <div class="section white" style="margin:40px; padding:40px;">
      ...
      <div class="col s12" style="margin-bottom:20px;"><a class="right btn-flat teal accent-4 white-text" href="{{URL::to('/customize-suit-style-jacket')}}">Continue</a></div>

      <div class="col s12" style="margin-bottom:20px; padding:20px; padding-top:0;">
        <div class="col s4">
          <div class="center col s2 " style="margin-top:150px">

...
@section('content')
    ...
    <ul class="col s12 breadcrumb">
			...
			<li><a class="active" style="padding-left:200px"><b>3.ADD MEASUREMENT DETAIL</b></a></li>
		</ul>
      ...
      <div class="row">
        ...
        <a href="{{URL::to('/alteration-walkin-transaction')}}" class="left btn tooltipped" data-position="top" data-delay="50" data-tooltip="Transfers you back home and clears current unsaved transaction" style="background-color:teal; padding:9.5px; padding-bottom:45px; margin-left:50px; color:white">Cancel Transaction</a>
      </div>
  ...
  <div id="save-transaction" class="modal modal-fixed-footer" style="height:200px; width:500px; margin-top:150px">        
    {!! Form::open() !!}
      ...
      <div class="modal-footer col s12" style="background-color:green; opacity:0.85">
        <a class="waves-effect waves-green btn-flat" href="{{URL::to('/alteration-walkin-transaction')}}"><font color="black">OK</font></a>
      </div>
    {!! Form::close() !!}
  </div>
  ...
  <div id="add-new-fields-measure" class="modal modal-fixed-footer row" style="height:400px; width:600px; margin-top:50px">
    ...
    <div class="modal-footer row">                  
      <div class="col s12">
        ...
        {!! Form::close() !!}
        <div class="col s8">
          <a href="{{URL::to('/alteration-checkout-measurement')}}" class="right waves-effect waves-green btn-flat">Cancel</a>
          <a class="right waves-effect waves-green btn-flat" href="{{URL::to('/alteration-checkout-measurement')}}"><font color="black">OK</font></a>
        </div>
      </div>
    </div>

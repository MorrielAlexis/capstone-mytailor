    ...
    <div class="col s12" style="padding-left:2%; padding-right:2%; font-family:'Segoe UI';">
      <div class="col s3" style="padding:0; margin-top:10px;">
        <ul class="collapsible white">
          ...
          <li class="sidemenu"><div><a href="{{URL::to('/customerprofile-company-order-tracking')}}" class="collapsible-header teal lighten-4"><font size="+1" color="teal">Order Tracking<i class="mdi-navigation-chevron-right right"></i></font></a></div></li>
                ...
                <div class="col s12">
                  <div class="col s12">
                    <div class="col offset-s8">
                      ...
                      <div class = "col s6">
                        <button  type = "submit" class="teal waves-effect waves-light btn-flat white-text" style="margin-top:10px; font-family:'Yatra One',cursive;" href="#!">Track</button>
                      </div>
                    </div>
                  </div>

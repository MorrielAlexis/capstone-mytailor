  ...
  <div class="main-wrapper" style="margin-top:30px">
    ...
    <div class="row">
      ...
      <div class="col s6 left">
         <a class="right waves-effect waves-light modal-trigger btn-floating tooltipped btn-large light-green accent-1" data-position="bottom" data-delay="50" data-tooltip="Create new package." href="#addpackage" style="color:black; margin-right:35px; margin-left: 20px;"><i class="large mdi-content-add"></i></a>
      </div>
    </div>
      ...
      <div class="card-panel">
        ...
        <div class="card-content"> 
            ...
            <table class = "table centered data-segmentPattern" align = "center" border = "1">
              <thead>
                <tr>
                  ...
                  <th data-field="Category Name">Package Name </th>
                  <th data-field="Garment Name">Segment 1</th>
                  <th data-field="Pattern Name">Segment 2</th>
                  <th data-field="Pattern Image">Segment 3</th>
                  <th data-field="Pattern Image">Segment 4</th>
                  <th data-field="Pattern Image">Segment 5</th>
                  <th data-field="Pattern Image">Description</th>
                  <th data-field="Pattern Image">Image</th>
              ...
              <tbody>
                ...
                <!--<td>{{ $packages->strPackageID }}</td>-->
                  ...
                  <td><a style="color:black" class="modal-trigger btn tooltipped btn-floating blue" data-position="bottom" data-delay="50" data-tooltip="Click to update package details" href="#edit{{ $packages->strPackageID }}"><i class="mdi-editor-mode-edit"></i></a>
                  <a style="color:black" class="modal-trigger btn tooltipped btn-floating red" data-position="bottom" data-delay="50" data-tooltip="Click to deactivate this package" href="#del{{ $packages->strPackageID }}"><i class="mdi-action-delete"></i></a></td>
                    ...
                    <div id="edit{{ $packages->strPackageID }}" class="modal modal-fixed-footer">                     
                     ...
                     <!--  <div class = "col s12" style="padding:15px;  border:3px solid white;">
                          ...
                          <div class="input-field col s6">                                                    
                            <select class="browser-default editSegment" id="{{ $packages->strPackageID }}" name='editSegment'>
                                  @foreach($segment as $segment_1)
                                    @if($packages->strSegPNameFK == $segment_1->strSegmentID && $segment_1->boolIsActive == 1)
                      ...
                      <div class = "col s12" style="padding:15px;  border:3px solid white;">
                          <div class="input-field col s12">
                            <input required value = "{{ $packages->strSegPName }}" id="editPatternName" name= "editPatternName" type="text" class="validate" required data-position="bottom" pattern="^[a-zA-Z\-'`\s]{2,}$">
                      ...
                      <div class = "col s12" style="padding:15px;  border:3px solid white; margin-bottom:40px">
                          <div class="file-field input-field col s12">
                            ...
                            <div class="file-path-wrapper">
                              <input value="{{$packages->strSegPImage}}" id="editImage" name="editImage" class="file-path validate" type="text" readonly="readonly">
                            </div>
                          </div>
                      </div>
                      </div> -->
                ...
                <div id="del{{ $packages->strPackageID }}" class="modal modal-fixed-footer">
                   ...
                   <!--  <div class = "col s12" style="padding:15px;  border:3px solid white;">
                        ...
                        <div class="input-field col s6">                                                    
                            <input type="text" value="{{$packages->strSegmentName}}" readonly>
                          <label>Segment</label>
                        </div>  
                    </div> 
                    ...
                    <div class = "col s12" style="padding:15px;  border:3px solid white;">
                        <div class="input-field col s12">
                          <input value = "{{ $packages->strSegPName }}" type="text" class="validate" readonly>
                          <label for="pattern_name">Pattern Name </label>
                        </div>
                    </div>
                           ...
                           <div class="input-field col s12">
                            ...
                            <input required id="delInactivePattern" name = "delInactivePattern" value = "{{$packages->strSegPInactiveReason}}" type="text">
                          </div> 
            ...
            <div id="addpackage" class="modal modal-fixed-footer">
              <h5><font color = "#1b5e20"><center>CREATE A PACKAGE/center> </font> </h5> 

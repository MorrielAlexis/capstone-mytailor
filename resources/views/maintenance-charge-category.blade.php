            ...
            <div class="card-content"><!-- card-content  --> 
              ...
              <div class="col s12 m12 l12 overflow-x">
                ...
                <tbody>
                  ...
                  <tr>
               		  <td>{{ $chargeCat->strFabricColorName}}</td>
              		  <td>{{ $chargeCat->txtFabricColorDesc}}</td>
              		  <td><a style="color:black" class="modal-trigger btn tooltipped btn-floating blue" data-position="bottom" data-delay="50" data-tooltip="Click to update data of thread count" href="#edit{{$chargeCat->strFabricColorID}}"><i class="mdi-editor-mode-edit"></i></a>
                    <a style="color:black" class="modal-trigger btn tooltipped btn-floating red" data-position="bottom" data-delay="50" data-tooltip="Click to remove data of thread count from the table" href="#del{{$chargeCat->strFabricColorID}}"><i class="mdi-action-delete"></i></a></td>


              	   <!-- Update FabricColor Modal --> 
                    <div id="edit{{$chargeCat->strFabricColorID}}" class="modal modal-fixed-footer"> 
                          ...
                          <div class="divider" style="height:2px"></div>
                              <div class="modal-content col s12">
                                ...
                                <div class="input-field">
                                      <input value = "{{$chargeCat->strFabricColorID}}" id="editfabricColor" name = "editfabricColor" type="hidden">
                                </div>

                              <div class = "col s12" style="padding:15px;  border:3px solid white;">
                                      <div class="input-field col s12">
                                            <input required value = "{{$chargeCat->strFabricColorName}}" id="editColorName" name = "editColorName" type="text" pattern="^[a-zA-Z\d\-'`]+(\s[a-zA-Z\-'`]+)?" class="validate" required data-position="bottom">
                                ...
                                <div class = "col s12" style="padding:15px;  border:3px solid white; margin-bottom:40px">
                                      <div class="input-field col s12">
                                            <input  value = "{{$chargeCat->txtFabricColorDesc}}" id="editColorDesc" name = "editColorDesc" type="text" class="validate">
              ...
              <!--**********DELETE***********-->
              <div id="del{{$chargeCat->strFabricColorID}}" class="modal modal-fixed-footer">                     
                <h5><font color = "#1b5e20"><center>ARE YOU SURE TO DEACTIVATE THIS COLOR?</center> </font> </h5>                       
                   {!! Form::open(['url' => 'maintenance/fabric-color/destroy']) !!}  
                    ...
                    <div class="modal-content col s12">
                          ...
                          <div class="input-field">
                            <input value="{{$chargeCat->strFabricColorID}}" id="delfabricColorID" name="delfabricColorID" type="hidden">
                          </div>

                      <div class = "col s12" style="padding:15px;  border:3px solid white;">
                          <div class="input-field col s12">
                            <label for="thread count name">Color Name </label>
                            <input value="{{$chargeCat->strFabricColorName}}" id="delfabricColorName" name="delfabricColorName" type="text" readonly>
                          </div>
                      </div>
                      ...
                      <div class = "col s12" style="padding:15px;  border:3px solid white;">
                          <div class="input-field col s12">
                            ...
                            <input value="{{$chargeCat->txtFabricColorDesc}}" id="delfabricColorDesc" name="delfabricColorDesc" type="text" readonly>
                          </div>
                      </div>

                          <div class="input-field col s12">
                            <label for="inactive_reason"> Reason for Deactivation <span class="red-text"><b>*</b></span> </label>
                            <input value="{{$chargeCat->strFabricColorInactiveReason}}" id="delInactivefabricColor" name="delInactivefabricColor" type="text" required>
                          </div>

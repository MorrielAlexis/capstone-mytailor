					...
					<div class="card-content">
						...
						<div class="col s12">					
							...
							<div class="col s12" style="margin-top:2px; padding-top:5px; margin-bottom:30px;">
						        <center><h4 style="color:teal"><b>Package: </b><font color="red">Unisex Set A</font><!--<a class="right btn-floating tooltipped btn-large blue" data-position="bottom" data-delay="50"  data-tooltip="CLick to print a receipt for current transaction" href="#!" style="color:black; margin-right:35px; margin-left: 20px;"><i class="large mdi-editor-mode-edit"></i></a>--></h4></center>
						        <center><p style="color:gray">All garments included in the package are listed below.</p></center>
						...
						<div class="col s12">
							<a class="right waves-effect waves-green btn" style="background-color:teal; margin-left:80px; margin-right:80px" href="{{URL::to('transaction/walkin-company-customize-orders')}}">Save</a>

								...
								<div class="row">
									...
									<!-- Customer Info -->
										<div class="col s12" style="margin-top:10px" hidden>
											...
											<div class="col s12">
												<div style="color:black" class="col s12">  
													<div class="col s3" style="color:teal; margin-top:4%;"><b>Company ID:</b></div>               
						                          	<div class="col s9" style="color:black; margin-top:3%; padding:0; font-size:18px"><b></b></div>
						                        </div>
					                    	</div>
					                    	<div class="col s12">
										...
										<div class="card-panel">
											<div class="card-content">
												<div class="row" style="display:none">
							                        ...
							                        <div style="color:black" class="input-field col s7">                 
							                          <input style="margin-left:180px; padding:5px; padding-left:10px" name="payment-info" type="text" class="">
							                          <label style="color:teal; margin-top:5px; margin-left:20px"><b>Total Amount Paid:</b></label>
							                        </div>

							                        <div style="color:black" class="input-field col s7">                 
							                          <input style="margin-left:180px; padding:5px; padding-left:10px" name="payment-info" type="text" class="">
							                          <label style="color:teal; margin-top:5px; margin-left:20px"><b>Outstanding Balance:</b></label>
							                        </div>
							                        ...
							                        <div style="color:black" class="input-field col s7">                 
							                          ...
							                          <label style="color:black; margin-top:5px; margin-left:20px"><b>Amount Tendeteal:</b></label>
							                        </div>
							                        ...
							                        <div class="container">
								                        <div style="color:black" class="input-field col s7">                 
								                          ...
								                          <label style="color:teal; margin-top:5px; margin-left:40px"><b>Change:</b></label>
								                        </div>
							                    	</div>
									...
									<!-- <div class="col s12">
										...
										<div class="card-panel" style="border: 4px black inset">
											<div class="card-content">
												<div class="row">
													<div class="col s12">
														<table class="table centeteal pending-payments" border="1">
															<thead style="color:gray">
																...
																<th data-field="due-date" style="color:teal">Due Date</th>
															</thead>
															<tbody>
															...
															@foreach($pending_payments as $pending_payment)
																...
																<tr>																
																	...
																	<td style="color:teal">{{ $pending_payment->dtPaymentDueDate}}</td>
																</tr>
																@endif
															@endforeach
															@endif
									...
									<h5><font color="teal"><center><b>Summary of Orders</b></center></font></h5>
											...
											<div class="modal-content col s12">
												...
												<div class="col s6">
													...
													<div class="col s6"><h6 style="color:teal; margin-top:15px"><b></b></h6></div>
														
												</div>

														<div class="container">
									                        <table class = "table centeteal order-summary" border = "1">
											       				<thead style="color:gray">
												          			<tr>
														...
														<div class="col s12" style="margin-bottom:50px">
															<p style="color:teal"><b>Due date of payment (pay balance before or on the said date):</b></p>
														</div>
	...
	<script type="text/javascript">
		function updateClock ( )
		 	...
		 	var currentTime = new Date ( );
		  	...
		  	// Pad the minutes and seconds with leading zeros, if requiteal

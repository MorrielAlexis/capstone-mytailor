	            ...
	            <div class="col s12"> 
	            	...
	            	<div class="col s12">
											...
											<h5><font color="teal"><center><b>Get An Access Code</b></center></font></h5>
												...
												{!! Form::open() !!}
													...
													<div class="modal-footer col s12">
										                <a class="waves-effect waves-green btn-flat" href="{{URL::to('transaction/walkin-individual-bulk-orders-payment-measure-detail')}}"><font color="black">Save and Print</font></a>
										                <a href="{{URL::to('/transaction/walkin-individual-bulk-orders-payment-measure-detail')}}" class="modal-action modal-close waves-effect waves-green btn-flat"><font color="black">Cancel</font></a>
										            </div>
												{!! Form::close() !!}
									</div>
	                    </div>
	                    ...
	                    <div class="right col s5">	                    	
	                    		...
	                    		<center><p><a href="{{URL::to('/transaction/walkin-individual-bulk-orders-measure-now')}}" class="modal-trigger"><font size="+1">Input necessary measurement details now for production to begin immediately</font></a></p></center>

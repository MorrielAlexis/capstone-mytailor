...
<html>
	...
	<body id="dabadehh" background="img/logo4.jpg">
						    ...
						    <div class="row margin">
			          			<div class="input-field col s9">
			       				...
			       				<div class="col s3" style="margin-top:14px;">
			       					<button type="submit" class="btn waves-effect waves-light col s12"><i class="material-icons" style="font-size:30px;">trending_flat</i></button>
			       				</div>
			       			</div>
		       			</div>
			      	</div>
			      		...
			      		<div style="padding:0; margin:0;">
					        <div class="row margin signup" style="padding:0px; margin:0;">
			          			<div class="col s8">
			       				...
			       				<div class="col s4" style="margin-top:23px;">
			       					<button class="modal-trigger btn waves-effect waves-light" href="#individualsignup"><i class="material-icons" style="font-size:30px;">person</i></button>
			       				</div>
		        			</div>
						    ...
						    <div class="row margin signup" style="padding:0px; margin:0;">
			          			<div class="col s8">
			       				...
			       				<div class="col s4" style="margin-top:23px;">
			       					<button class="modal-trigger btn waves-effect waves-light" href="#companysignup"><i class="material-icons" style="font-size:30px;">group</i></button>
			       				</div>
			       			</div>
		       			</div>
			      	</div>
		...
		<!--INDIVIDUAL-->
	    <div id="individualsignup" class="modal" style="width:35%; margin-top:50px; background-color:#eeeeee;">
	        ...
	        {!! Form::close() !!}
	       	...
	       	<div class="modal-footer" style="background-color:#eeeeee;">
	            ...
	            <div><a href="" class="right modal-action modal-close waves-effect waves-green green white-text btn-large btn-flat"><b><font size="+1">Sign up</font></b></a>
	        </div>

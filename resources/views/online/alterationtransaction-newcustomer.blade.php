                    ...
                    <div id="summary-of-order" class="modal modal-fixed-footer" style="height:500px; width:800px; margin-top:30px">
                      <h5><font color="teal"><center><b>Summary of Orders</b></center></font></h5>
                          ...
                          <div class="modal-footer col s12">
                            ...
                            <a href="{{URL::to('transaction/online-alteration-add-newcustomer-checkout-info')}}" class="modal-action modal-close waves-effect waves-green btn-flat"><font color="black">Yes</font></a>

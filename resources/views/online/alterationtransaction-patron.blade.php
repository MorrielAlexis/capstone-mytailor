  ...
  <div class="row section white container" style="margin-top:40px; padding:40px;">
    ...
    <div class="row" style="margin-top:40px;">
  	...
  	<div class="cols 12">
	      ...
	      <label for="icon_prefix"><font size="3">Transaction No.:</font></label>
	    </div>
	</div>
	<div class="row">
...
<!--MODALS-->
  ...
  <div id="resetOrder" class="modal modal-fixed-footer" style="height:250px; width:500px; margin-top:150px">
    ...
    <div class="modal-footer col s12" style="background-color:red; opacity:0.85">
      <button type="submit" class="waves-effect waves-green btn-flat" href="{{URL::to('/online-alterationtransaction-patron')}}"><font color="black">Yes</font></button>
      <a href="" class="modal-action modal-close waves-effect waves-green btn-flat"><font color="black">No</font></a>
    </div>
  </div> 

<!--PROCEED TO CHECKOUT-->
    <div id="summary-of-order" class="modal modal-fixed-footer row" style="height:500px; width:800px; margin-top:30px">
        ...
        {!! Form::open() !!}
          ...
          <div class="modal-content col s12">
            ...
            <div class="col s12" style="margin-bottom:50px" >
              <div><p style="color:gray">Estimated time to finish all orders:<p style="color:black" id="total-time"></p></p></div>
              <div><p style="color:gray">Total Amount to Pay:<p style="color:black" id="total-price"></p></p></div>
            </div>
          ...
          <div class="modal-footer col s12">
            <div class="col s6">
              <p style="margin-left:20px;">
                ...
                <label for="details">Use previous details</label>
              </p>
            </div>
            <div class="col s6">
              <a class="waves-effect waves-green btn-flat" href="{{URL::to('/online-check-out')}}"><font color="black">PROCEED</font></a>

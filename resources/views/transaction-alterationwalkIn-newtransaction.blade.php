...
<div class="main-wrapper"  style="margin-top:30px">
    ...
    <div class="row">
        <div class="col s12 m12 l12">
            ...
            <center><div class="btn green white-text container" style="height:50px; margin-top:20px; padding-top:5px;" href="{{URL::to('/transaction-walkInindividualcheckout')}}"><font color="black" size="+1">Proceed to CHECKOUT</font></div></center>

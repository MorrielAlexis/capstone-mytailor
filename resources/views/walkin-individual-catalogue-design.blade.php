		...
		<div class="col s12 m12 l12">
			...
			<div class="col s12">
				...
				<div class="col s12"><div class="divider" style="height:2px; margin-top:20px; margin-bottom:20px"></div></div>
					<div class="col s12">
						<a class="right waves-effect waves-green btn" style="background-color:teal; margin-left:80px; margin-right:80px" href="{{URL::to('transaction/walkin-individual-customize-orders')}}">Save</a>

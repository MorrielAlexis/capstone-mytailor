		...
		<div class="col s12 m12 l12">
			...
			<div class="col s12">
						...
						<div class="col s4" style="margin-top:20px; margin-bottom:20px">
			           		 <div class="container">
			         			 ...
			         			 <div class="center col s12">
				          				<input name="catDesigns" type="radio" class="filled-in" id="male_set"/>
				...
				<div class="col s12"><div class="divider" style="height:2px; margin-top:20px; margin-bottom:20px"></div></div>
					<div class="col s12">
						<a href="{{URL::to('transaction/walkin-individual')}}" class="btn" style="color:white; margin-left:30px; background-color:teal; border:3px teal solid">Cancel Transaction</a>
						<a class="right waves-effect waves-green btn" style="background-color:teal; margin-left:80px; margin-right:30px" href="{{URL::to('transaction/walkin-individual-customize-orders')}}">Save</a>
						<a href="{{URL::to('transaction/walkin-individual-customize-orders')}}" class="right waves-effect waves-green btn" style="background-color:teal">Cancel</a>
					</div>

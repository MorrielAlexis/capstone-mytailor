...
@section('content')
	...
	<div class="row">
      <div class="col s12 m12 l12">
        ...
        <center><h7 style="color:gray">Daily, Monthly and Annual Sales</h7></center> 
      </div>
    </div>
		          	...
		          	<div style="padding-left:5%">
					      ...
					      <label for="daily-sales">Daily</label>
					      		...
					      		<div class="daily_sales" style="display:none; padding-left:5%; padding-right:3%">
									    ...
									    <input class="left with-gap col s4" disabled="true" name="radio-daily-sales" type="radio" id="daily-transac-no" />
									    <label for="daily-transac-no" style="margin-top:3%; margin-bottom:3%;">Transaction #</label>
											<select class="right browser-default col s8">
											    <option value="" disabled selected>Choose a Job Order</option>
											    <option value="1">Job Order 1</option>
											    <option value="2">Job Order 2</option>
											    <option value="3">Job Order 3</option>
											</select>
									    <br>
						...
						<div class="row">
					      ...
					      <label for="monthly-sales">Monthly</label>
					      		...
					      		<div class="monthly_sales" style="display:none; padding-left:5%; padding-right:3%">
									    ...
									    <br>
									    <input class="with-gap col s4" disabled="true" name="radio-monthly-sales" type="radio" id="monthly-transac-no" />
									    <label for="monthly-transac-no" style="margin-top:3%; margin-bottom:3%;">Transaction #</label>
									    	<select class="right browser-default col s8">
											    <option value="" disabled selected>Choose a Job Order</option>
											    <option value="1">Job Order 1</option>
											    <option value="2">Job Order 2</option>
						...
						<div class="row">
					      ...
					      <label for="annual-sales">Annual</label>
					      		...
					      		<div class="yearly_sales" style="display:none; padding-left:5%; padding-right:3%">
									    ...
									    <br>
									    <input class="with-gap col s4" disabled="true" name="radio-yearly-sales" type="radio" id="yearly-transac-no" />
									    <label for="yearly-transac-no" style="margin-top:3%; margin-bottom:3%;">Transaction #</label>
									    	<select class="right browser-default col s8">
											    <option value="" disabled selected>Choose a Job Order</option>
											    <option value="1">Job Order 1</option>
											    <option value="2">Job Order 2</option>

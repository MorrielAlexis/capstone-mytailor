		      ...
		      <div class="col s12 m12" style="padding-left:3%; margin-top:0">
		        ...
		        <!-- <div class="col s12">
	        		...
	        		<div class="divider" style="background-color:gray; height:2px; margin-top:6%; margin-bottom:3%"></div>		
		          	...
		          	<!-- User will choose from the following options to view on as reports:
		          	<!  *Daily, *Monthly, and *Annual sales , etc (A user may only choose ONE)
		          	...
		          	<div style="padding-left:5%">
					      ...
					      <label for="daily-sales"><b>Daily</b></label>
					      		...
					      		<div class="daily_sales" style="display:none; padding-left:5%; padding-right:3%; padding-top:2%">
									    <input onclick="document.getElementById('d_transac_no').disabled = true" class="with-gap" disabled="true" name="radio-daily-sales" type="radio" id="daily-current-date"/>
									    <label for="daily-current-date"">Current Date</label>
									 
									    <br>
			
									    <input onclick="document.getElementById('d_transac_no').disabled = false" class="left with-gap col s4" disabled="true" name="radio-daily-sales" type="radio" id="daily-transac-no" />
									    <label for="daily-transac-no" style="margin-top:3%; margin-bottom:3%;">Specify a Transaction No</label>
											<select class="right browser-default col s8" style="margin-top:1%" id="d_transac_no" disabled="disabled">
						...
						<!-- Weekly -->
					      ...
					      <label for="weekly-sales"><b>Weekly</b></label>
					      		...
					      		<div class="weekly_sales" style="display:none; padding-left:5%; padding-right:3%; padding-top:2%">
									    <input onclick="document.getElementById('w_transac_no').disabled = true" class="with-gap" disabled="true" name="radio-weekly-sales" type="radio" id="weekly-current-date"/>
									    <label for="weekly-current-date"">Current Week</label>
									 
									    <br>
			
									    <input onclick="document.getElementById('w_transac_no').disabled = false" class="left with-gap col s4" disabled="true" name="radio-weekly-sales" type="radio" id="weekly-transac-no" />
									    <label for="weekly-transac-no" style="margin-top:3%; margin-bottom:3%;">Specify a Transaction No</label>
											<select class="right browser-default col s8" style="margin-top:1%" id="w_transac_no" disabled="disabled">
											    <option value="" disabled selected>Choose your option</option>
											    <option value="1">Transaction 1</option>
											    <option value="2">Transaction 2</option>
											    <option value="3">Transaction 3</option>
						...
						<div class="row">
					      ...
					      <label for="monthly-sales"><b>Monthly</b></label>
					      		...
					      		<div class="monthly_sales" style="display:none; padding-left:5%; padding-right:3%; padding-top:2%">
									    ...
									    <input onclick="document.getElementById('m_transac_no').disabled = true; document.getElementById('start_month').disabled = true; document.getElementById('end_month').disabled = true" class="with-gap" disabled="true" name="radio-monthly-sales" type="radio" id="monthly-current-month" />
									    <label for="monthly-current-month">Current Month</label>

									    <br>

									    <input onclick="document.getElementById('m_transac_no').disabled = false; document.getElementById('start_month').disabled = true; document.getElementById('end_month').disabled = true" class="with-gap col s4" disabled="true" name="radio-monthly-sales" type="radio" id="monthly-transac-no" />
									    <label for="monthly-transac-no" style="margin-top:3%; margin-bottom:3%;">Specify a Transaction No</label>
									    	<select class="right browser-default col s8" style="margin-top:1%" id="m_transac_no" disabled="disabled">
											    <option value="" disabled selected>Choose your option</option>
											    <option value="1">Transaction 1</option>
											    <option value="2">Transaction 2</option>
											    <option value="3">Transaction 3</option>
									    ...
									    <input onclick="document.getElementById('m_transac_no').disabled = true; document.getElementById('start_month').disabled = false; document.getElementById('end_month').disabled = false" class="with-gap" disabled="true" name="radio-monthly-sales" type="radio" id="monthly-between" />
						...
						<div class="row">
					      ...
					      <label for="quarterly-sales"><b>Quarterly</b></label>
					      		...
					      		<div class="quarterly_sales" style="display:none; padding-left:5%; padding-right:3%; padding-top:2%">
									    <input onclick="document.getElementById('q_transac_no').disabled = true" class="with-gap" disabled="true" name="radio-quarterly-sales" type="radio" id="quarterly-current-date"/>
									    <label for="quarterly-current-date"">Current Quarter</label>
									 
									    <br>
			
									    <input onclick="document.getElementById('q_transac_no').disabled = false" class="left with-gap col s4" disabled="true" name="radio-quarterly-sales" type="radio" id="quarterly-transac-no" />
									    <label for="quarterly-transac-no" style="margin-top:3%; margin-bottom:3%;">Specify a Transaction No</label>
											<select class="right browser-default col s8" style="margin-top:1%" id="q_transac_no" disabled="disabled">
											    <option value="" disabled selected>Choose your option</option>
											    <option value="1">Transaction 1</option>
											    <option value="2">Transaction 2</option>
											    <option value="3">Transaction 3</option>
						...
						<div class="row">
					      ...
					      <label for="annual-sales"><b>Annual</b></label>
					      		...
					      		<div class="yearly_sales" style="display:none; padding-left:5%; padding-right:3%; padding-top:2%">
									    <input onclick="document.getElementById('y_transac_no').disabled = true; document.getElementById('start_year').disabled = true; document.getElementById('end_year').disabled = true" class="with-gap" disabled="true" name="radio-yearly-sales" type="radio" id="yearly-current-date" />
									    <label for="yearly-current-date">Current Year</label>
									    <br>
									    <input onclick="document.getElementById('y_transac_no').disabled = false; document.getElementById('start_year').disabled = true; document.getElementById('end_year').disabled = true" class="with-gap col s4" disabled="true" name="radio-yearly-sales" type="radio" id="yearly-transac-no" />
									    <label for="yearly-transac-no" style="margin-top:3%; margin-bottom:3%;">Specify a Transaction No</label>
									    	<select class="right browser-default col s8" style="margin-top:1%" id="y_transac_no" disabled="disabled">
											    <option value="" disabled selected>Choose your option</option>
											    <option value="1">Transaction 1</option>
											    <option value="2">Transaction 2</option>
											    <option value="3">Transaction 3</option>
									    ...
									    <br>
									    <input onclick="document.getElementById('y_transac_no').disabled = true; document.getElementById('start_year').disabled = false; document.getElementById('end_year').disabled = false" class="with-gap" disabled="true" name="radio-yearly-sales" type="radio" id="yearly-between" />
		    ...
		    <!--Preview will be here-->	              
		    	<div class="row" style="padding-left:2%; padding-right:2%">
			      	<div class="col s12 m12" style="padding-left:3%; margin-top:5%; background-color:white">
			        	<div style="padding-top:3%; min-width: 50%; padding-bottom:13%">
			        		...
			        		<div class="row col s12" style="padding-bottom:15%">
			        			...
			        			<div class="col s12" style="margin-top:4%">
			        				<span><b>QUANTITY - SALES by Job Order</b></span>
			        				<div class="col s12" style="border:2px gray solid">
			        				CHART will be here	
			        				</div>
			        				<a href="" class="right black-text btn teal lighten-4" style="position:right; margin-top:1%">Export as PDF</a>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
        ...
        $('.data-salesByJobOrder').DataTable();
        $('#salesByJobOrder').DataTable();

    });

    $(document).ready(function() {

          $('.data-reactsalesByJobOrder').DataTable();

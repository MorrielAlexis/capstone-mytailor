              ...
              <div class="divider" style="background-color:gray; height:2px; margin-top:6%; margin-bottom:3%"></div>    
                ...
                <label for="daily-sales">Daily</label>
                    ...
                    <div class="daily_sales" style="display:none; padding-left:5%; padding-right:3%">
                      ...
                      <input class="left with-gap col s4" disabled="true" name="radio-daily-sales" type="radio" id="daily-customer-no" />
                      <label for="daily-customer-no" style="margin-top:3%; margin-bottom:3%;">Customer #</label>
                      <select class="right browser-default col s8">
                          <option value="" disabled selected>Choose a Customer Number</option>
            ...
            <div class="row">
                ...
                <label for="monthly-sales">Monthly</label>
                    ...
                    <div class="monthly_sales" style="display:none; padding-left:5%; padding-right:3%">
                      ...
                      <br>
                      <input class="with-gap col s4" disabled="true" name="radio-monthly-sales" type="radio" id="monthly-customer-no" />
                      <label for="monthly-customer-no" style="margin-top:3%; margin-bottom:3%;">Customer #</label>
                        <select class="right browser-default col s8">
                          <option value="" disabled selected>Choose a Customer Number</option>
                          <option value="1">Customer 1</option>
                          <option value="2">Customer 2</option>
            ...
            <div class="row">
                ...
                <label for="annual-sales">Annual</label>
                    ...
                    <div class="yearly_sales" style="display:none; padding-left:5%; padding-right:3%">
                      ...
                      <br>
                      <input class="with-gap col s4" disabled="true" name="radio-yearly-sales" type="radio" id="yearly-customer-no" />
                      <label for="yearly-customer-no" style="margin-top:3%; margin-bottom:3%;">Customer #</label>
                        <select class="right browser-default col s8">
                          <option value="" disabled selected>Choose a Customer Number</option>
                          <option value="1">Customer 1</option>
                          <option value="2">Customer 2</option>

...
<html>
	...
	<body>
        ...
        @foreach($customer_orders as $j => $order)
			...
			@if($payment->strTransactionFK != $customer_info->strJobOrderID AND $payment->strJO_CustomerFK == $customer_info->strIndivID)
		<div class="col s12" style="margin-top:2%" @if($payment->strJO_CustomerFK == $customer_info->strIndivID) hidden @endif>
		...
		<div class="col s12" style="margin-top:1%" @if($payment->strJO_CustomerFK == $customer_info->strIndivID) hidden @endif>
			<table width="98%">
				<tbody>
					<tr>

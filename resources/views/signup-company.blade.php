	    ...
	    <div class="row	" style="margin:50px;">
			<div class="container z-depth-5" style="background-color:#eeeeee;">
				...
				<div class="col s12" style="background-color:#eeeeee;">
			        ...
			        <div class = "col s12" style="padding:15px;">
			            <div class="input-field col s12">
			                <input required id="strCompanyName" name = "strCompanyName" placeholder="Company Name" type="text" class="validate" required data-position="bottom" pattern="^[a-zA-Z\-'`]+(\s[a-zA-Z\-'`]+)?" maxlength="30" minlength="2">

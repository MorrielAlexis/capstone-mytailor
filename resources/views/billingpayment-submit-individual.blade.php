...
@section('content')
	...
	<div class="row">
      <div class="col s12 m12 l12">
        ...
        <center><h5>Payment - Individual</h5></center>
      </div>
    </div>
    ...
    <div class="row" style="padding:30px">
		...
		<div class="col s12">
			{!! Form::open(['url' => 'transaction/payment/individual/print-receipt', 'method' => 'GET']) !!}
		        ...
		        <div class="row">
		       	...
		       	<div class="row" style="background-color:white; padding:40px">
	            	<div class="col s12">
						...
						<a class="center" href="#!" onclick="window.open('/transaction/payment/individual/generate-receipt')">

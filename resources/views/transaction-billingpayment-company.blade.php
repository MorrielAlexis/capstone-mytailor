								...
								<div class="row">
									...
									<!-- Customer Info -->
										<div class="col s12" style="margin-top:10px">
											<div class="col s6">
					                    		<div style="color:black" class="col s12">     
					                    			<div class="col s5" style="color:teal; margin-top:4%"><b>Company Name:</b></div>            
						                          	<div class="col s7" style="color:black; margin-top:3%; padding:0; font-size:18px"><b>Pfizer Phil, Inc.</b></div>
					                        	</div>
					                    	</div>
											<div class="col s6">
												<div style="color:black" class="col s12">  
													<div class="col s4" style="color:teal; margin-top:4%; padding:0"><b>Customer ID:</b></div>               
						                          	<div class="col s8" style="color:black; margin-top:3%; padding:0; font-size:18px"><b>CUSTC001</b></div>
						                        </div>
					                    	</div>
					                    	<div class="col s12">
					                    		<div class="col s12">
					                    		...
					                    		<div class="col s12">
					                    			<div class="col s12">
						                    			...
						                    			<div class="col s9" style="color:white; background-color: gray; margin-top:4%; padding:0"><font style="padding-left:4%">Kindly settle unpaid payment(s) before or on due date</font></div>
						                    		</div>

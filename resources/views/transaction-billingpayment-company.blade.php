								...
								<div class="row">
									...
									<div class="col s12" style="margin-top:30px">
								                   ...
								                   {!! Form::open(['url' => 'transaction/payment/company/save-payment', 'method' => 'POST']) !!}
								                    <div class="payment-form" id="payment-form" style="display:block">
														...
														<div class="col s12" style="margin-top:30px">
															...
															<a href="{{URL::to('transaction/payment/company/home')}}" class="left btn tooltipped" data-position="bottom" data-delay="50" data-tooltip="Click to clear all fields for payment process" style="background-color:teal">Cancel</a>
														</div>
													</div>
													{!! Form::close() !!}
													</div>
										...
										<div class="col s5">
											<div class="card-panel">
											<div class="card-content">
											{!! Form::open(['url' => 'transaction/payment/company/customer-info', 'method' => 'GET']) !!}
												@for($i = 0; $i < count($orders); $i++)
												@if($orders[$i]->strTermsOfPayment != "Full Payment")
												@if($payments[$i]->strTransactionFK == $orders[$i]->strJobOrderID)

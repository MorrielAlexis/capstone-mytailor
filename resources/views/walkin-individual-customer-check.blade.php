	        ...
	        <div class="row">
	       	...
	       	<div class="row" style="background-color:white; ">
            	<div class="col s12">
					...
					<div class="customer-form col s12" id="custId" style="display:none; padding:5%">
					<div class="col s12"><div class="divider" style="height:2px; background-color:teal; margin-top:3%"></div></div>
						<div class="container">
							<div class="col s5" style="padding-top:3%"><center><b><font size="+1.5">Enter Customer's ID</font></b></center></div>
							<div class="col s7">

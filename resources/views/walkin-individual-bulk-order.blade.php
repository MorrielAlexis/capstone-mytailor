			...
			<div class="col s12">
				...
				<div id="shoppingCart" class="card-panel">
					<div class="card-content">
									...
									<div id="reset-order" class="modal modal-fixed-footer" style="height:250px; width:500px; margin-top:120px;">
										...
										{!! Form::open() !!}
												...
												<div class="modal-footer col s12" style="background-color:red; opacity:0.85">
									                <a class="waves-effect waves-green btn-flat" href="{{URL::to('transaction/walkin-individual-bulk-orders')}}"><font color="white">OK</font></a>
									                <a href="{{URL::to('transaction/walkin-individual-bulk-orders')}}" class="modal-action modal-close waves-effect waves-green btn-flat"><font color="white">Cancel</font></a>
									            </div>
											{!! Form::close() !!}
									</div>
									...
									<div id="view-cart" class="modal modal-fixed-footer">
										...
										{!! Form::open() !!}
												...
												<div class="modal-footer col s12">
									                <a class="waves-effect waves-green btn-flat" href="{{URL::to('transaction/walkin-individual-bulk-orders')}}"><font color="teal"><b>OK</b></font></a>
									                <a href="{{URL::to('transaction/walkin-individual-bulk-orders')}}" class="modal-action modal-close waves-effect waves-green btn-flat"><font color="teal"><b>Cancel</b></font></a>
									            </div>
											{!! Form::close() !!}
									</div>
						</div>
						...
						<a href="{{URL::to('transaction/walkin-individual')}}" class="left" style="margin-top:30px; margin-left:15px; font-size:18px"><i class="mdi-navigation-arrow-back"></i><b><u>Go Back Home</u></b></a>
